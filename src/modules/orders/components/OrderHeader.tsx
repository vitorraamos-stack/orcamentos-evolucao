...
export function OrderHeader({ order, assignees, canEdit, transitions, onEdit, onTransition }: { order: OsOrder; assignees: OrderAssignee[]; canEdit: boolean; transitions: { board: "art" | "production"; value: ArtStatus | ProdStatus }[]; onEdit: () => void; onTransition: (board: "art" | "production", value: ArtStatus | ProdStatus) => void }) {
